...
func NewISO6391(languageCode string) (ISO6391, error) {
	return ISO6391{languageCode: languageCode}, nil
}
...
func DetectISO6391FromText(text string) (ISO6391, error) {
	...
	iso6391, err := NewISO6391(isoCode)
	if err != nil {
		return ISO6391{}, err
	}
...
func (i *ISO6391) Name() string {
	switch strings.ToLower(i.languageCode) {
	case "en":
		return "english"
	case "es":
		return "spanish"
